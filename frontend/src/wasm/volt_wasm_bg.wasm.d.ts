...
export const json_extract: (a: number, b: number, c: number, d: number) => [number, number];
export const json_extract_batch: (a: number, b: number, c: number, d: number) => [number, number];
export const json_format: (a: number, b: number) => [number, number];
